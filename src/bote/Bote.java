...
public class Bote {
    ...
    /**
     * Constructor de la clase bote con 5 parámetros
     * @param contenido. Centilitros de pintura disponibles en el bote
     * @param centilitros_metro. Centrilitros necesarios para pintar un metro cuadrado
     ...
     * @param metros
     * @throws Exception. Si no hay pintura suficiente o sea negativa 
     */
     ...
     * @param centilitros
     * @param centimos
     * @throws Exception. Si se da una cantidad negativa de dinero o centilitros, que se supere la capacidad del bote, o no tener dinero suficiente
     */
